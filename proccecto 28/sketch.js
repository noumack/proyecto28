...
//crea aquí la función mouseDragged y realiza un Matter.Body.setPosition 
function mouseDragged (){
  Matter.Body.setPosition(stoneObj.body, {x:mouseX, y:mouseY});
}

//crea aquí la función mouseReleased y llama a funcion fly de class launcher
function mouseReleased(){
launcherObject.fly();

}

//crea aquí la función keyPressed if(keyCode ===32) y realiza 
//Matter.Body.setPosition y llama funcion attach de launcher
function keyPressed(){
if(keyCode ===32){
